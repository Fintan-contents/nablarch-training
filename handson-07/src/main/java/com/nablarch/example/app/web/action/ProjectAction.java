...
public class ProjectAction {
    ...
    public HttpResponse list(HttpRequest request, ExecutionContext context) {
        ...
        // 検索条件を設定するための変数
        ProjectSearchDto searchCondition = null;

        // handson-07 step1
        // 検索条件として使用するために、searchCondition変数に、searchForm変数のプロパティを設定してください。
        // 以前のエクササイズでも使用した、BeanUtilクラスを使用して実装してください。

        // handson-07 step2
        //  検索条件として使用するために、searchCondition変数に、LoginUserPrincipalから取り出したユーザIDを設定してください。
