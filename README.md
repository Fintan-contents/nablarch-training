...
| [15](./handson-15/README.md) | 基本   | ETLを使って、CSVファイルの内容をDBに登録してみよう | ETLを利用したバッチアプリケーションでCSVファイルの内容をDBに登録する方法を学びます。 |
| [16](./handson-16/README.md) | 基本   | RESTfulウェブサービスを作成してみよう | NablarchのJAX-RSサポートを利用した、RESTfulウェブサービスの作り方を学びます。|
...
| [nablarch-handson-app-rest](./nablarch-handson-app-rest/README.md) | -   | 解答 | 16の解答(完成品)のプログラムです。 |
